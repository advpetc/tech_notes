...
public:
    ListNode* removeNthFromEnd(ListNode* head, int n) {
        ...
        // when b reaches the end, a will be n nodes away in front of b
		  while (b) {
            a = a -> next;
            b = b -> next;
        }
