...
public:
    string removeKdigits(string a, int k) {
        ...
        for (char c : a) {
          	...
          	// smaller chars,  because there could be multiple smaller chars in front of i
