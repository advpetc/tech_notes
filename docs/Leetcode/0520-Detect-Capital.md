...
`allCap`: excluding the first character, the rest of the substring is all capitals.
`allLower`: excluding the first character, the rest of the substring is all capitals.
`firstCap`: the first character is capital.
