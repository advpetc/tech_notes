...
For each cell, we have three requirements to fulfill:
...
However, you don't need to satisfy case 2 and case 3 at the same time, and you should always choose the direction that makes it easier to reach your goal. What I mean by "easier" is that `HP` is the least in all three cases.
