...
We can use either DFS or BFS to solve this problem, and depending on the requirement, DFS would require setting the call stack space to hold the recursion tree, and BFS requires creating a stack space that is at most equal to the size of the grid.
