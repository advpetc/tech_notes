...
We use BFS to expand level by level, using a counter to keep track of how many levels there are, which is the answer to our problem.
...
public:
    int orangesRotting(vector<vector<int>>& g) {
        ...
        // step 2: iterate over all the neighbours that are currently 1
